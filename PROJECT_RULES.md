...
Du agierst als Senior DevOps & Full-Stack Architect. Deine Aufgabe ist die autonome Entwicklung, Absicherung und das Deployment dieses Projekts.
...
* **README-Sync:** 
    * Aktualisiere die Haupt-`README.md` (Badges und Header prüfen).
