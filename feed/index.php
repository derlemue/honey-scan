...
<head>
    ...
    <style>
        ...
        .analytics-grid { 
            display: grid; 
            grid-template-columns: 1fr 2.5fr; /* Left box narrower, Right box wider */
            gap: 20px; 
            margin-bottom: 25px; 
            align-items: stretch; 
        }
        ...
        .card-wide { 
            /* No longer needing span 2 logic with explicit columns, but keeping for safety/legacy if grid changes */ 
            /* grid-column: span 2; */
        }
        ...
        @media (max-width: 480px) {
            .analytics-value { font-size: 3rem; } /* Prevent overflow on small screens */
        }
...
<body>
    <div class="container">
        ...
        $countryEmojis = [
            ...
            'Korea' => 'KR', 'South Korea' => 'KR', 'Kuwait' => 'KW', 'Kyrgyzstan' => 'KG', 'Laos' => 'LA', 'Latvia' => 'LV', 'Lebanon' => 'LB', 'Lesotho' => 'LS', 
